...
//取开奖结果，结算
_nodeCron2.default.schedule('20 */5 9-23 * * *', function () {
            ...
            if (previousPeriodNum === periodNum) {
                ...
                return driver.findElement(By.className('r1')).findElements(By.css('span')).then(function (obj) {
                    ...
                    if (obj.length === 4) {
                        ...
                        var _num2 = tempSum % 10;
                        tempSum = 0;

                        for (var _i2 = 12; _i2 < 18; _i2++) {
                            tempSum += parseInt(arr[_i2], 10);
                        }
                        var _num3 = tempSum % 10;

                        var sum = _num + _num2 + _num3;
                        ...
                        //顺子  赔率14
                        if (_num2 - _num === 1 && _num3 - _num2 === 1 || _num3 - _num === 1 && _num2 - _num3 === 1 || _num2 - _num === 1 && _num - _num3 === 1 || _num - _num2 === 1 && _num3 - _num === 1 || _num - _num3 === 1 && _num3 - _num2 === 1 || _num - _num2 === 1 && _num2 - _num3 === 1) {
                            winningList.push({
                        ...
                        //开奖结果打印
                        console.log(_num + " + " + _num2 + " + " + _num3 + " = " + sum);
                        ...
                        (0, _base_dao.baseDao)('bettingRecord', 'getBettingRecordByPeriodNum', params).then(function (obj) {
                            ...
                            lotteryRecord.num1 = _num;
                            lotteryRecord.num2 = _num2;
                            lotteryRecord.num3 = _num3;
