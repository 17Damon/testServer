    ...
    if (now.hour() === 9 && now.minute() === 0) {
        ...
        driver.findElement(By.className('col-lg-1 col-sm-2 col-xs-6 ng-scope ng-binding')).click().then(function () {
            return driver.sleep(500).then(function () {
                return driver.findElement(By.id('period')).getText().then(function (obj) {
                    console.log(obj);
                    var periodNum = parseInt(obj, 10);
                    ...
                    if (previousPeriodNum === periodNum) {
                        ...
                        return driver.findElement(By.className('r1')).findElements(By.css('span')).then(function (obj) {
                            ...
                            if (obj.length === 4) {
                                //num1
                                return obj[0].getText().then(function (obj) {
                                    num1 = parseInt(obj, 10);
                                }).then(function () {
                                    //num2
                                    return obj[1].getText().then(function (obj) {
                                        num2 = parseInt(obj, 10);
                                    }).then(function () {
                                        //num3
                                        return obj[2].getText().then(function (obj) {
                                            num3 = parseInt(obj, 10);
                                        }).then(function () {
                                            //sum
                                            return obj[3].getText().then(function (obj) {
                                                var sum = parseInt(obj, 10);
                                                ...
                                                params.lotteryRecord = lotteryRecord;
                                                return (0, _base_dao.baseDao)('lotteryRecord', 'insertLotteryRecord', params).then(function (obj) {
                                                    // console.log(winningList);
                                                    ...
                                                    (0, _base_dao.baseDao)('bettingRecord', 'getBettingRecordByEndTime', params).then(function (obj) {
                                                        ...
                                                        for (var i = 0; i < obj.length; i++) {
                                                            ...
                                                            for (var j = 0; j < obj[i].bettingContents.length; j++) {
                                                                ...
                                                                for (var k = 0; k < winningList.length; k++) {
                                                                    if (obj[i].bettingContents[j].bettingName === "point" && obj[i].bettingContents[j].bettingName === winningList[k].bettingName && obj[i].bettingContents[j].pointNum === winningList[k].pointNum || obj[i].bettingContents[j].bettingName !== "point" && obj[i].bettingContents[j].bettingName === winningList[k].bettingName) {
                                                                        ...
                                                                        if (obj[i].bettingContents[j].bettingName === "point") {
                                                                            ...
                                                                            if ((sum === 13 || sum === 14) && (obj[i].bettingContents[j].bettingName === "small" || obj[i].bettingContents[j].bettingName === "big" || obj[i].bettingContents[j].bettingName === "single" || obj[i].bettingContents[j].bettingName === "double" || obj[i].bettingContents[j].bettingName === "bigSingle" || obj[i].bettingContents[j].bettingName === "smallSingle" || obj[i].bettingContents[j].bettingName === "bigDouble" || obj[i].bettingContents[j].bettingName === "smallDouble") && obj[i].bettingContents[j].bettingNum > 10000) {
                                                                                bettingGain.push({
                                                                                    bettingName: obj[i].bettingContents[j].bettingName,
                                                                                    oddsNum: 1,
                                                                                    bettingNum: obj[i].bettingContents[j].bettingNum
                                                                            ...
                                                                            } else if ((sum === 13 || sum === 14) && (obj[i].bettingContents[j].bettingName === "small" || obj[i].bettingContents[j].bettingName === "big" || obj[i].bettingContents[j].bettingName === "single" || obj[i].bettingContents[j].bettingName === "double") && obj[i].bettingContents[j].bettingNum > 1000 && obj[i].bettingContents[j].bettingNum <= 10000) {
                                                                                bettingGain.push({
                                                                                    bettingName: obj[i].bettingContents[j].bettingName,
                                                                                    oddsNum: 1.5,
                                                                                    bettingNum: obj[i].bettingContents[j].bettingNum
                                                                            ...
                                                                            } else if ((sum === 13 || sum === 14) && (obj[i].bettingContents[j].bettingName === "bigSingle" || obj[i].bettingContents[j].bettingName === "smallSingle" || obj[i].bettingContents[j].bettingName === "bigDouble" || obj[i].bettingContents[j].bettingName === "smallDouble") && obj[i].bettingContents[j].bettingNum <= 10000) {
                                                                                bettingGain.push({
                                                                                    bettingName: obj[i].bettingContents[j].bettingName,
                                                                                    oddsNum: 3,
                                                                                    bettingNum: obj[i].bettingContents[j].bettingNum
                                                        ...
                                                        for (var _i = 0; _i < dupWinnerList.length; _i++) {
                                                            var tempSum = 0;
                                                            for (var _j = 0; _j < winnerBonusList.length; _j++) {
                                                                if (dupWinnerList[_i] === winnerBonusList[_j].accountName) {
                                                                    tempSum = tempSum + winnerBonusList[_j].gainBonus;
                                                                }
                                                            }
                                                            gainBonusRecordList.push({
                                                                accountName: dupWinnerList[_i],
        ...
        //
        //             //开奖时间
        //             let lotteryDate = $('div .lott_cont table tr td').next().next().next().html() + ":00";
        //             console.log(lotteryDate);
        //
        //             //存储开奖结果
        //             let params = {};
        ...
        //             lotteryRecord.winningList = winningList;
        //             params.lotteryRecord = lotteryRecord;
        //             return baseDao('lotteryRecord', 'insertLotteryRecord', params)
        //                 .then(obj=> {
        //                     // console.log(winningList);
        //
        //                     //个人中奖结果列表
        ...
        //                     params.endTime = endTime;
        //                     //结算
        //                     baseDao('bettingRecord', 'getBettingRecordByEndTime', params)
        //                         .then(obj=> {
        //                             console.log("bettingRecord_num");
        //                             console.log(obj.length);
        //                             //遍历所有人下注信息
